      ...
      <View style={[styles.cardContainerStyle,styles.fixalbumspace]}>
        ...
        <View style={styles.thumbnailContainerStyle}>
          ...
          <View style={styles.ContentStyle}>
            ...
            <Text style={styles.cardtextstyle}>{albumData[0].year}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.cardContainerStyle,styles.fixalbumspace]}>
        ...
        <View style={styles.thumbnailContainerStyle}>
          ...
          <View style={styles.ContentStyle}>
            ...
            <Text style={styles.cardtextstyle}>{albumData[1].year}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.cardContainerStyle,styles.fixalbumspace]}>
        ...
        <View style={styles.thumbnailContainerStyle}>
          ...
          <View style={styles.ContentStyle}>
            ...
            <Text style={styles.cardtextstyle}>{albumData[2].year}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.cardContainerStyle,styles.fixalbumspace]}>
        ...
        <View style={styles.thumbnailContainerStyle}>
          ...
          <View style={styles.ContentStyle}>
            ...
            <Text style={styles.cardtextstyle}>{albumData[3].year}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.cardContainerStyle,styles.fixalbumspace]}>
        ...
        <View style={styles.thumbnailContainerStyle}>
          ...
          <View style={styles.ContentStyle}>
            ...
            <Text style={styles.cardtextstyle}>{albumData[4].year}</Text>
          </View>
        </View>
      </View>
